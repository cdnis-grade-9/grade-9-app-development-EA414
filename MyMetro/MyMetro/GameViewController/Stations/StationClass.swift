...
// -- HK ISLAND --
    ...
    static var st_wongchukhang = newStation(id: 7, name: "Wong Chuk Hang St.", crowdedness: 1, stationSizeLvl: 1, stationFacilityLvl: 1, x: 398, y: 370, loc: "HK", isConnected: false, score: 2)
...
// -- KOWLOON --
    static var st_kowloon = newStation(id: 9, name: "Kowloon Station", crowdedness: 3, stationSizeLvl: 1, stationFacilityLvl: 1, x: 275, y: 227, loc: "KLN", isConnected: false, score: 2)
    static var st_tst = newStation(id: 10, name: "Tsim Sha Tsui St.", crowdedness: 3, stationSizeLvl: 1, stationFacilityLvl: 1, x: 368, y: 253, loc: "KLN", isConnected: false, score: 2)
    static var st_austin = newStation(id: 11, name: "Austin Station", crowdedness: 2, stationSizeLvl: 1, stationFacilityLvl: 1, x: 308, y: 192, loc: "KLN", isConnected: false, score: 2)
    static var st_whampoa = newStation(id: 12, name: "Whampoa Station", crowdedness: 1, stationSizeLvl: 1, stationFacilityLvl: 1, x: 390, y: 195, loc: "KLN", isConnected: false, score: 2)
